-- Script para actualizar los maestros en Supabase
-- Ejecuta esto en: https://supabase.com/dashboard/project/tjbdedlujgjrnxazvpxa/sql/new

-- 1. Actualizar los maestros con los datos correctos
...
SELECT key, value FROM kv_store_65077a1f WHERE key = 'maestros';
